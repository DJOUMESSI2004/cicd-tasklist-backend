...
describe("TaskController", () => {
	...
	describe("createTask", () => {
		...
		it("should return 201 with the created task", async () => {
			...
			const req = createMockRequest({ body: { title: "New Task", description: "New description" } });
			const res = createMockResponse();
		...
		it("should return 201 with the created task when description is undefined", async () => {
			mockService.create.mockResolvedValue(mockTask);
		...
		it("should return 400 for missing title", async () => {
			const req = createMockRequest({ body: { description: "New description" } });
			const res = createMockResponse();
	...
	describe("updateTask", () => {
		...
		it("should return 200 with the updated task", async () => {
			...
			const req = createMockRequest({ params: { id: "1" }, body: { title: "Updated Task", description: "Updated description" } });
			const res = createMockResponse();
		...
		it("should return 400 for invalid task ID", async () => {
			const req = createMockRequest({ params: { id: "invalid" }, body: { title: "Updated Task", description: "Updated description" } });
			const res = createMockResponse();
